...
const char PAGE_irBulbControl[] PROGMEM = R"=====(<html><head><link rel="stylesheet" href="index.css"><style></style></head><body 
onload="bodyLoaded()"><label for="selectedCommand">Choose a command:</label> 
<select name="selectedCommand" id="selectedCommand"><option value="01">
Brightness Up</option><option value="02">Brightness Down</option><option 
value="04">off</option><option value="03">on</option><option value="05">red
</option><option value="06">green</option><option value="07">blue</option>
<option value="08">white</option><option value="09">light red</option><option 
value="10">light green</option><option value="11">light blue</option><option 
value="12">flash</option><option value="13">orange</option><option value="14">
turquoise</option><option value="15">purple</option><option value="16">strobe
</option><option value="17">slightly lighter orange</option><option value="18">
navy</option><option value="19">pink</option><option value="20">fade</option>
<option value="21">yellow</option><option value="22">darker navy</option><option
 value="23">rose</option><option value="24">smooth</option></select> <button 
class="btn infobtn" onclick="sendIrCommand()">Send Command</button></body>
<script>
