...
Choose a command:</h1><select name="selectedCommand" id="selectedCommand" 
size="24"><option value="01">Brightness Up</option><option value="02">
Brightness Down</option><option value="04">ON</option><option value="03">OFF
</option><option value="05">Red</option><option value="06">Green</option><option
 value="07">Blue</option><option value="08">White</option><option value="09">
Orange</option><option value="10">Light green</option><option value="11">Purple
</option><option value="12">Flash</option><option value="13">Orange</option>
<option value="14">Green (aqua)</option><option value="15">Purple</option>
<option value="16">Strobe</option><option value="17">Yellow</option><option 
value="18">Purple</option><option value="19">Light Blue</option><option 
value="20">Fade</option><option value="21">Yellow</option><option value="22">
Darker blue</option><option value="23">Rose</option><option value="24">Smooth
</option></select><br><button class="btn infobtn" 
onclick='window.location.href="/"'>Back</button> <button class="btn infobtn" 
onclick="sendIrCommand()">Send Command</button></body><script>
