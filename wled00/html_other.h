...
const char PAGE_irBulbControl[] PROGMEM = R"=====(<html><head><style>
...
</style></head><body onload="bodyLoaded()"><label for="selectedCommand">
Choose a command:</label> <select name="selectedCommand" id="selectedCommand">
<option value="01">Brightness Up</option><option value="02">Brightness Down
</option><option value="04">on</option><option value="03">off</option><option 
value="05">red</option><option value="06">green</option><option value="07">blue
</option><option value="08">white</option><option value="09">light red</option>
<option value="10">light green</option><option value="11">light blue</option>
